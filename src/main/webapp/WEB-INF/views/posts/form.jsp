						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<form:input class="form-control" id="descriptionTitle"
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<form:input class="form-control" id="descriptionSubTitle"
										path="descriptionSubTitle" />
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<form:textarea class="form-control" id="descriptionBody"
